...
exports.getAssetPreview = function(asset) {
  // /extensions/periodicjs.ext.reactapp/img/icons/
  // if (asset.attributes && asset.attributes.encrypted_client_side) {
  //   return '/extensions/periodicjs.ext.reactapp/img/icons/file82.svg';
  // } else
  if (asset.assettype && asset.assettype.match('audio')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/audio55.svg';
  } else if (asset.assettype && asset.assettype.match('music')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/music232.svg';
    ...
    return '/extensions/periodicjs.ext.reactapp/img/icons/code41.svg';
  } else if (asset.assettype && asset.assettype.match('video')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/video170.svg';
  } else if (asset.assettype && asset.assettype.match('word')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/word6.svg';
  } else if (asset.assettype && asset.assettype.match('excel')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/x16.svg';
  } else if (asset.assettype && asset.assettype.match('zip')) {
    return '/extensions/periodicjs.ext.reactapp/img/icons/compressed1.svg';
    ...
    return '/extensions/periodicjs.ext.reactapp/img/icons/text140.svg';
  } else {
    return '/extensions/periodicjs.ext.reactapp/img/icons/file87.svg';
  }
};