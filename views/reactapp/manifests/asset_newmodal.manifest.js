...
module.exports = {
  containers: {
    [`${reactapp.manifest_prefix}standard/content/assets/newmodal`]: {
      layout: {
        component: 'div',
        children: [{
            component: 'Content',
          ...
          },
          {
            ...
            'props': {
              ...
              'onSubmit': {
                ...
                'url': `${reactapp.settings.basename}${reactapp.manifest_prefix}contentdata/standard/assets?handleupload=true&format=json&forcequerytobody=true`,
