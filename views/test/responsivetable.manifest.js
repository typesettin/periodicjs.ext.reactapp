...
module.exports = {
  "containers": {
    "/r-admin/content/testresponsivetable": {
      "layout": {
        "component": "Hero",
        "props": {
          "size": "isFullheight"
          ...
          "children": [{
            ...
            "children": [{
              ...
              "props": {
                ...
                "headers": [
                  { "label": "#", "value": "--idx-ctr--" },
                  { "label": "ID", "sortid": "id", "sortable": false },
                  { "label": "First Name", "sortid": "first_name", "sortable": false },
                  { "label": "Email", "sortid": "email", "sortable": false },
                  { label: ' ', formRowButtons: true, }
                ],
                "rows": [{ "id": 1, "first_name": "Tana", "last_name": "Hawkswood", "email": "thawkswood0@discuz.net" },
